...
if __name__ == "__main__":
    ...
    # Define search query
    search = 'subject:"English (Second Language)" OR subject:"English Instruction" OR subject:"Second Language Instruction"'
    ...
    records.to_csv("data/eric_records.csv", index=False)
